...
alias bzr='python C:/Python25/Scripts/bzr'
alias cheetah='python C:/Python25/Scripts/cheetah'
alias rst2html='python C:/Python25/Scripts/rst2html.py'
alias rst2latex='python C:/Python25/Scripts/rst2latex.py'
alias rst2newlatex='python C:/Python25/Scripts/rst2newlatex.py'
alias rst2s5='python C:/Python25/Scripts/rst2s5.py'
